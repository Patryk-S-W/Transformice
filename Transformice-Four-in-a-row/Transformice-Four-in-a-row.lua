...
function eventNewGame()
  ...
  jogador[1] = nil
  jogador[2] = nil
  ui.addTextArea(1, "<p align='center'><vp>[Zajmij miejsce Kosmka]", nil, 20, 220, 120, 30, 0, 0, 0, true)
  ui.addTextArea(2, "<p align='center'><vp>[Zajmij miejsce Kosmka]", nil, 660, 220, 120, 30, 0, 0, 0, true)
  ui.removeTextArea(3)
  ui.removeTextArea(4)
  tfm.exec.addPhysicObject(8000, 0, 0, {type=14, miceCollision=false})
  tfm.exec.setUIMapName("Four in a row")
  jogador = {}
...
function verificaVitoria(p)
  ...
  if p1 and p2 then
    ...
    ui.addTextArea(4, string.format("<p align='center'><font color='#ffffff' size='60px'>%s wygrał/-a!", jogador[p]), nil, 0, 120, 800, 400, 0, 0, 0, true)
  end
  intervalo = os.time()+2000
end
...
function verificaEmpate()
  if modo == "partida" then
    if semJogada() then
      ui.addTextArea(3, "", nil, 0, 0, 800, 400, 1, 1, 0.3, true)
      ui.addTextArea(4, string.format("<p align='center'><font color='#ffffff' size='60px'>Rysuj"), nil, 0, 120, 800, 400, 0, 0, 0, true)
      modo = "fim"
      tempoFim = os.time() + 10000
    end
  end
